        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Have a project in mind or want to discuss photography services? Reach out to me using the form below.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              <ContactForm onSubmit={handleSubmit} formData={formData} onChange={handleChange} />
            </div>
          </div>
        </div>
      </main>
